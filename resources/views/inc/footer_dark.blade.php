    ...
    <div class="row-1">
        <div class="col-1">
            <ul class="unstyled-list">
                ...
                <a href="{{route ('tour')}}" class="menu-btn footer"><li>Авіа</li></a>
                <a href="{{route ('tour')}}" class="menu-btn footer"><li>Індивідуальні</li></a>
        ...
        <div class="col-1">
            <ul class="unstyled-list">
                ...
                <a href="{{route ('cruise')}}" class="menu-btn footer"><li>Напрямки</li></a>
